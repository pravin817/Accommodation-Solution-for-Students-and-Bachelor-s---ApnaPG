    ...
    <main className=" max-w-[1200px] mx-auto xl:px-10 py-12 flex min-h-[80vh] relative">
      <section className=" flex flex-row gap-16 items-start flex-auto">
        {user?.photoUrl ? (
          ...
          <div className="flex flex-col gap-4 justify-center items-center w-[350px] h-[250px] shadow-xl rounded-3xl p-7 border sticky top-[128px]">
            <p className="text-4xl text-white font-semibold px-7 py-5 rounded-full bg-[#222222] flex justify-center items-center">
            ...
            <div className=" flex flex-col justify-center items-center">
              ...
              {user?.name.lastName === "guest" ? (
                ...
                <p className="text-sm font-medium">{user?.name.lastName}</p>
              )}
            </div>
          </div>
        )}
          ...
          <div className=" max-w-sm">
            ...
            <div className=" max-w-xs flex flex-col gap-4 items-start">
              ...
              <p className=" text-sm text-[#717171]">
                Your ApnaPG profile is an important part of every reservation.
