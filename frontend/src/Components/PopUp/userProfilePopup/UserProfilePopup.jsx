...
const UserProfilePopup = ({ showPopup, setShowPopup, popupData }) => {
  ...
  return (
    <>
      {!showPopup ? null : (
        <div className="absolute inset-0 w-full h-screen bg-[#0000005c] popup-overlay z-[100]">
          <div
            ref={popUpRef}
            className="absolute left-[27.5%] right-[27.5%] top-[12%] h-[65vh] profile-popup-container w-[45vw] bg-[#ffffff] shadow-2xl rounded-xl overflow-hidden"
          >
